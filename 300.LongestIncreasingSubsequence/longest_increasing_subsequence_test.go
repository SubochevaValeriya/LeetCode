...
func TestWordBreak(t *testing.T) {
	testCases := []TestCase{
		//{Name: "case with [10,9,2,5,3,7,101,18]", nums: []int{10, 9, 2, 5, 3, 7, 101, 18}, Expected: 4},
		{Name: "case with [0,1,0,3,2,3]", nums: []int{0, 1, 0, 3, 2, 3}, Expected: 4},
